...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(s.averageGrade.equals(averageGrade) && s.id.equals(id) && firstName.equals(s.firstName) &&
                lastName.equals(s.lastName) && averageGrade.equals(s.averageGrade))
            return true;
    ...
    public int hashCode() {
        ...
        int c = (int)(1 ^ (l>>>32));
        return 31 * (firstName.hashCode() + lastName.hashCode() + (int)id + c);
